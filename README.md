  Connect 4 AI with Monte Carlo and Alpha Beta Pruning: A program that takes in a board state and gives back the best possible move for that state. It includes testing data and a paper.
